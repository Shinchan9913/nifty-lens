...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        // Cozy office palette (warm cream / wood / terracotta + sage)
        cream: "#f4efe3",
        parchment: "#fbf8f0",
        wood: "#8a5a3b",
        terracotta: "#b9763f",
        sage: "#6f8f6a",
        ink: "#3a342a",
        // Tremor light tokens, tuned cozy
        tremor: {
          brand: {
            faint: "#fbf1e9",
            muted: "#f0d3bf",
      ...
      boxShadow: {
        ...
        "tremor-card": "0 1px 3px 0 rgb(0 0 0 / 0.08), 0 1px 2px -1px rgb(0 0 0 / 0.08)",
